...
%TODO: on a vure plus haut que l'allocation statique amené a une mauvaise utilisation des resources car...
...
%L'article s'intéresse à différante politique d'accés au noeud de données en fonction des patternes d'accès au données par l'applicaiton.
